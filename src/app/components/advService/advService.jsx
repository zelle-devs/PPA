...
//         <picture>
//           {/* Mobile image loaded on screens 768px or narrower */}
//           <source
...
//           <img
//             src="/images/services/signboard.jpeg"
//             alt="Signboard background"
//             className="main_sign_board_img"
//           />
//         </picture>
//       </div>
      ...
      mm.add(
        ...
        (context) => {
          ...
          const tl = gsap.timeline({
            scrollTrigger: {
              trigger: containerRef.current,
              // Mobile pins right when the section reaches top of screen; desktop retains center alignment
              start: isMobile ? "top top" : "center center+=100",
              end: "+=2400",
              pin: true,
              scrub: 1.2,
              anticipatePin: 1,
