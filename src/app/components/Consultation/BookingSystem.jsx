...
import { updateStepInURL, getStepFromPath } from '../consultation-comp/utils/urlParams';
...
const BookingSystem = () => {
    ...
    const generateGoogleCalendarUrl = ({ date, timeSlot, medium, platform, companyName, clientName }) => {
        ...
        const title = encodeURIComponent(`PPA Consultation`);
    ...
    const handleConfirm = () => {
        if (validateStep2()) {
            ...
            fetch('https://ajgrouphqapi.zellehost.com/api/ppa-consultations', {
                method: 'POST',
                headers: {
